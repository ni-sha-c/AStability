...
def main(argv):
    ...
    parser.add_argument("mode", help="<train> <transform> <eval> <energy> specify operation", default='eval')  
    ...
    tt.train_test(trainloader, testloader, args.arch, dataset, cfg.precision, args.retrain, args.checkpoint, device)
